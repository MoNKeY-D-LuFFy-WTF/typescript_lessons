...
const arr_06: (number | boolean)[] = [12, 21, false, 21, false];
console.log(arr_06);
const arr_07: Array<string | number> = ['hello', 1, 2];
console.log(arr_07);

//Кортежи
const cort_01: [string, number] = ['alex', 25];
console.log(cort_01);
cort_01.push(2);
console.log(cort_01);
...
const cort_02: [number, number, string?] = [25, 100];
console.log(cort_02);

//Если кол-во елементов в кортеже неопределено
const cort_03: [number, ...string[]] = [222, 'alex', 'maxim'];
console.log(cort_03);
